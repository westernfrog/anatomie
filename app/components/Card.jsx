    ...
    <>
      ...
      >
        <Image
          ...
          width={500}
          height={500}
          className="w-full h-72 object-cover object-center rounded-s-lg"
          alt="Title"
        />
        <div className="absolute rounded-lg w-full h-full inset-0 bg-black/20"></div>
        <div className="p-6 bg-neutral-800 rounded-e-lg w-full lg:h-full">
          <h1 className="text-xl tracking-tight font-semibold mb-2">
            {props.title}
          </h1>
          <p className="text-sm text-neutral-400">{props.desc}</p>
        </div>
      </Link>
    </>
  );
